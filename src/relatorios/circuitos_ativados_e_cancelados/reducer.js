const initial_state = {
    columns: [
        ...
        { name: "tx_instalacap_c_impostos", title: "Instalação C/ Imposto" },
        ...
        { name: "data_distrato", title: "Data Distrato" },
        ...
        { name: "data_ativacao", title: "Data de Ativação" },
        { name: "dt_export", title: "Data de Exportação" },
        { name: "status_credito", title: "Status do Crédito" },
        { name: "r_deduzido", title: "Deduzido" },
        { name: "r_pendente", title: "Pendente" },
    ],
    rows: [],
    pages: 1,
    items: 0,
