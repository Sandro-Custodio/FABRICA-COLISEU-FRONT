...
import { downloadModeloLinksSnoa, uploadFileLinksSnoa, downloadCriticasSnoa } from "../actions";
        ...
        <div style={{ display: "flex", justifyContent: "space-between" }}>
            <div style={{ display: "flex" }}>
                <IconButton
                    ...
                    onClick={() => downloadModeloLinksSnoa()}
                >
                    Download Modelo
  </IconButton>
                <Dropzone
