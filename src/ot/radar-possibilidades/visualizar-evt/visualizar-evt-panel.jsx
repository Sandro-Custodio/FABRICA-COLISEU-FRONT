            ...
            <Row>
              <Row>
                <LabelInput
                  ...
                  readOnly
                  placeholder={
                    _.get(evt, "requested_at")
                      ? moment(_.get(evt, "requested_at")).format("DD/MM/YYYY")
                      : "[n/a]"
                  }
                ...
                <LabelInput
                  ...
                  readOnly
                  placeholder={
                    _.get(evt, "deadline_at")
                      ? moment(_.get(evt, "deadline_at")).format("DD/MM/YYYY")
                      : "[n/a]"
                  }
                ...
                <Grid cols="12 8">
                  <Row>
                    ...
                    <LabelInput
                      ...
                      label="Data Proposta"
                      placeholder={
                        _.get(evt, "responsed_at")
                          ? moment(_.get(evt, "responsed_at")).format(
                              "DD/MM/YYYY"
                            )
                          : "[n/a]"
                      }
                ...
                <Grid cols="8">
                  <Row>
                    <LabelInput
                      ...
                      readOnly
                      placeholder={
                        _.get(evt, "approved_at")
                          ? moment(_.get(evt, "approved_at")).format(
                              "DD/MM/YYYY"
                            )
                          : "[n/a]"
                      }
            ...
            <Row>
              <Row>
                <Field
                  ...
                  time={false}
                  placeholder={
                    _.get(evt, "cancelled_at")
                      ? moment(_.get(evt, "cancelled_at")).format("DD/MM/YYYY")
                      : ""
                  }
                  readOnly
                />
                <Field
                  ...
                  placeholder={
                    _.get(evt, "status_id")
                      ? _.get(evt, "evt_status.description")
                      : "Selecione"
                  }
                  readOnly
                />
                ...
                <Field
                  ...
                  name="remarks"
                  placeholder={
                    _.get(evt, "remarks") ? _.get(evt, "remarks") : ""
                  }
                  label="Motivo"
                  readOnly
                />
