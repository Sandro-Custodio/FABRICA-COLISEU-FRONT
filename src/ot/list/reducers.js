...
const INITIAL_STATE = {
  ...
  defaultColumnWidths: [
    ...
    { columnName: "own_ot_code", width: 120 },
    { columnName: "ot_status", width: 100 },
    { columnName: "seg_id", width: 100 },
    { columnName: "seg_operator_a", width: 100 },
    { columnName: "seg_ponta_a", width: 100 },
    ...
    { columnName: "ot_type_name", width: 100 },
    { columnName: "seg_situation", width: 100 },
    { columnName: "seg_qtd_links", width: 100 },
    { columnName: "seg_speed", width: 100 },
    { columnName: "seg_project", width: 100 },
    { columnName: "ot_subproject_name", width: 100 },
    { columnName: "rede", width: 100 },
    { columnName: "ot_ended_at", width: 100 }
  ],
  ot_types: [],
  areas: [],
  element_types: [],
